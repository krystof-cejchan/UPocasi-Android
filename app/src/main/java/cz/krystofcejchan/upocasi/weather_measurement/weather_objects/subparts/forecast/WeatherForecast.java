...
public class WeatherForecast {
    ...
    public WeatherForecast(@NotNull String location, @NotNull TIME time, @NotNull DAY... days) throws IOException, JSONException {
        this(location, new TIME[]{time}, days);
    }

    public WeatherForecast(@NotNull String location, @NotNull DAY day, @NotNull TIME... times) throws IOException, JSONException {
    ...
    public WeatherForecast(@NotNull String location, @NotNull TIME[] times, @NotNull DAY... days) throws IOException, JSONException {
