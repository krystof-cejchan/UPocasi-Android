 ...
 */
class AfterTomorrow(location: String, vararg times: TIME) : IForecastDayTimesAndDays {
    /**
     *
    ...
    init {
        ...
        for (t in times) super.addHour(ForecastAtHour(jsonObject, day, t))
        System.gc()
    }

    override val day: DAY
        get() = DAY.AFTER_TOMORROW
