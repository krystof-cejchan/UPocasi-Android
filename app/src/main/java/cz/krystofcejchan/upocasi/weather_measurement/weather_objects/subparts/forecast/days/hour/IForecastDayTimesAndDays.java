...
public interface IForecastDayTimesAndDays {
     ...
     * @throws CannotSearchForAll           {@link DAY} or {@link TIME} is set to ALL; you can get single object of {@link cz.krystofcejchan.lite_weather_lib.weather_objects.subparts.forecast.days.hour.ForecastAtHour} only for certain DAY and TIME
     */
    static @NotNull
    ForecastAtHour getMatchingObjectFrom(DAY day, TIME time) throws NoDataFoundForThisDayAndTime, CannotSearchForAll {
     ...
     * add Forecast object
     *
     * @param forecast {@link cz.krystofcejchan.lite_weather_lib.weather_objects.subparts.forecast.days.hour.ForecastAtHour} object containing weather data for specific day and time(hour)
     */
